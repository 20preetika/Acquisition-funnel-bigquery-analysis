...
## Tools
BigQuery SQL — UNNEST for the nested fields, COUNTIF for conditional aggregation. Repo on GitHub.
...
## Limitations
Only one month of data (Aug 2017) — I'd want to see this hold across a longer window before calling it a real trend. Also no actual marketing spend/cost data in this public dataset, so this measures conversion efficiency, not true ROI.
